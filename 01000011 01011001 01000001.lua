local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/PHGS971/CYASTUDIOSui/refs/heads/main/Redzhubui.txt"))()
...
local Window = Library:MakeWindow({
    ...
    SubTitle = "by PHGS",
    LoadText = "Carregando...",
    Flags = "CYASTUDIOSHUB_Broookhaven"
})
...
InfoTab:AddParagraph({ "Owner / Developer:", "PHGS and STUDIOS CYA" })
InfoTab:AddParagraph({ "Colaborações", "GTZ, e mais outros" })
InfoTab:AddParagraph({ "Você está usando:", "CYA STUDIOS HUB Brookhaven" })
