...
Background.Image = "rbxassetid://113977525656869"
...
Title.Text = "CYA STUDIOS HUB beta"
...
local Paragraph = Tab1:AddParagraph({"Criadores", "PHGS \n Coquette_Source"})


  
  Tab1:AddButton({
    Name = " - Copiar @ do Youtube",
    Callback = function()
      setclipboard("@PHGS_ofc") -- Copia o @
      setclipboard("https://https://youtube.com/@PHGS_ofc") -- Copia o link também, se quiser só o @, remova esta linha
...
-- Nome e Bio
--=========================
game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1RPNam1eTex1t"):FireServer("RolePlayName", "🕵️CYA STUDIOS HUB🔥")
game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1RPNam1eTex1t"):FireServer("RolePlayBio", "por PHGS")
local args = {
	"PickingRPBioColor",
	Color3.new(1, 0.016362309455871582, 0)
}
